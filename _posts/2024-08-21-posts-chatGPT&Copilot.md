...
header:
  image: 
  teaser: https://image.olim.cc/ai.olim.ca/teaser/2024-08-21-gamma-th.png
layout: blog
...
![tsla code](https://image.olim.cc/ai.olim.ca/2024/tsla-20240821.png)

接着我又用对话的方式让chatGPT写了一段python代码，从雅虎抓取数据，显示某只股票的期权gamma信息。鉴于我对期权greek本身不是很了解，所以也提不出啥具体有用的要求，下面的图是我在和它对话的过程中，不断调整出来的代码运行的结果：

![gamma code](https://image.olim.cc/ai.olim.ca/2024/2024-08-21-gamma.png)
